...
class PB01Scenario:
    ...
    # QC
    qc_available: Dist = field(default_factory=lambda: Dist(2, 0.5, 1, 3))
    qc_total: int = 3
    # Confidence
    confidence_initial: Dist = field(default_factory=lambda: Dist(0.90, 0.03, 0.85, 0.95))
    # Mutations
